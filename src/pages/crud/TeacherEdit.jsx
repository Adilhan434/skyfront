...
const TeacherEdit = () => {
    ...
    const fetchTeacher = async () => {
        try {
            ...
            const { username, first_name, last_name, gender, address, phone, email } = response.data;
            setFormData({
                username: username || '',
            ...
            setError('Не удалось загрузить данные учителя');
        }
    };
    ...
    // Create a clean data object with only the fields your backend expects
    const submitData = {
        ...
        // Remove username if it's read-only in your serializer
    ...
    try {
        const response = await api.patch(`/accounts/users/${id}/`, submitData);
